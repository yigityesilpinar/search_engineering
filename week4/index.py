...
def index_file(file, index_name, stop_event, host, max_docs=2000000, batch_size=200):
    docs_indexed = 0
...
def main(source_dir: str, file_glob: str, index_name: str, workers: int, host: str, max_docs: int, batch_size: int,
    ...
    with Manager() as manager:
        ...
        with concurrent.futures.ProcessPoolExecutor(max_workers=workers) as executor:
            futures = [executor.submit(index_file, file, index_name, stop_event, host, max_docs, batch_size) for file in
                       files]
